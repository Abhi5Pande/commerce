...
urlpatterns = [
    ...
    path("listing/<str:category>",views.show_category,name="category"),
    path("close/<int:p_id>", views.close_item, name="close"),
    path("addBid/<int:p_id>", views.addBid , name = "addBid")
]
